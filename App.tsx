  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.content}>
        <Text style={styles.greeting}>Hello, I’m Krishna Samirbhai Rao!</Text>
        <Text style={styles.info}>Student ID: N01687444</Text>
        ...
        <View style={styles.goals}>
          ...
          <Text style={styles.goal}>• Master state management</Text>
...
const styles = StyleSheet.create({
  ...
  greeting: { fontSize: 22, fontWeight: 'bold', color: '#2c3e50', textAlign: 'center', marginBottom: 10 },
